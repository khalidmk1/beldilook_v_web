...
<div class="container mt-3">
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('adresse') is-invalid @enderror" id="adresse2" name="adresse2" value="{{$data['adresse2']}}" required>
        @else
        <input type="text" class="form-control @error('adresse') is-invalid @enderror" id="adresse2" name="adresse2" value="{{old('adresse2')}}" required>
        @endif
        @error('adresse2')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
