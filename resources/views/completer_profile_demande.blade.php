...
<div class="container mt-3">
    ...
    <form action={{route('demande_vendeur')}} method="POST" enctype="multipart/form-data">
      @csrf
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control border-top-0 border-right-0 border-left-0 @error('adresse') is-invalid @enderror" id="adresse2" name="adresse2" value="{{$data['adresse2']}}" required>
        @else
        <input type="text" class="form-control border-top-0 border-right-0 border-left-0 @error('adresse') is-invalid @enderror" id="adresse2" name="adresse2" value="{{old('adresse2')}}" required>
        @endif
        @error('adresse2')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
